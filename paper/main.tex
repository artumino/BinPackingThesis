...
\begin{document}
    ...
    \appendix
    \chapter{Appendix A}
    \input{tests/literature_all_bins}
    \input{tests/literature_all_times}
    \input{tests/literature_all_cageratio}
    \input{tests/use_case}
    ...
    \\
    Finally, many thanks to my family, my mom Patrizia, my father Severino, and my sister Giulia for always supporting me during this journey.
