...
% Text Node
\draw (457.45,167.3) node [anchor=north west][inner sep=0.75pt]    {$\left( x_{i}^{\prime } ,\ y_{i}^{\prime } ,z_{i} +h_{i}\right)$};
% Text Node
...
% Text Node
\draw (875,196.07) node [anchor=north west][inner sep=0.75pt]    {$\left( x_{i}^{\prime } ,\ y_{i}^{\prime } ,z_{i} +h_{i}\right)$};
% Text Node
