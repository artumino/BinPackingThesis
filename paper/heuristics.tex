...
Given a supporting set $Z^s_b$ defined as in \cref{sec:support_planes}, which is used by our constructive heuristic.
The resulting state expansion procedure is detailed in Algo. \ref{algo:state_successor}.
