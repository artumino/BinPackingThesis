...
% Text Node
\draw (525,246.4) node [anchor=north west][inner sep=0.75pt]    {$z^{\text{max}}$};
% Text Node
\draw (66,308.4) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 255; green, 0; blue, 0 }  ,opacity=1 ]  {$W\cdot D\cdot z^{\text{max}}$};
% Text Node
...
% Text Node
\draw (936,246.4) node [anchor=north west][inner sep=0.75pt]    {$z^{\text{max}}$};
% Text Node
\draw (709,233.4) node [anchor=north west][inner sep=0.75pt]  [color={rgb, 255:red, 255; green, 0; blue, 0 }  ,opacity=1 ]  {$W\cdot D\cdot z^{\text{max}}$};
