In this thesis, we address the 3D single bin-size bin packing problem with vertical support (3D-BPPWS).
...
To the best of our knowledge no formulations for the 3D-BPPWS exists.
