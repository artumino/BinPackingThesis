...
Given a support area threshold which is usually equal to $\alpha_s=0.7$ and a tolerance, which in our case is equal to $\beta_s=1\text{cm}$, we can define an item as supported if
\begin{enumerate}
