...
An exact approach to the 3D-SBSBPP was proposed in \citep{martello2000three} through a two-level branch-and-bound search and the use of a staircase placement method derived from the 2D-BPP field.
